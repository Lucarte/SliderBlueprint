...
function move(e) {
	...
	let activeIndex;
	allPics.forEach((pic, idx) => {
		// we want to loop through the pics and indeces
		if (pic.classList == "img-show") {
			// find which pics have this class name
	...
	if (eventId == "right") {
		// by a click to the R
		if (activeIndex >= allPics.length - 1) {
